...
# 创建测试脚本，完整模拟Fantasy Land模式的操作流程
def test_fantasy_complete():
    print("========================================")
    print("    Fantasy Land模式完整操作测试")
    print("========================================")
    ...
    if game.table.fantasy_mode:
        ...
        ai_player.hand['temp'] = test_cards[:fantasy_cards]  # AI也拿相同的牌
